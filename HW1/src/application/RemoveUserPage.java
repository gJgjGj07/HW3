...
public class RemoveUserPage {
    ...
    /**
     * Constructs a RemoveUserPage for the admin to remove a user.
     *
     * @param dbHelper      The DatabaseHelper instance used for database interactions.
     * @param primaryStage  The primary stage for the application.
     * @param userId        The ID of the admin user.
     * @param userName      The name of the admin user.
     * @param qHandler      The QuestionHandler instance used to handle questions.
     * @param aHandler      The AnswerHandler instance used to handle answers.
     * @param uHandler      The UserHandler instance used to handle users.
     * @param rHandler      The ReviewHandler instance used to handle reviews.
     * @param user          The current User object.
     */
    public RemoveUserPage(DatabaseHelper dbHelper, Stage primaryStage, int userId, String userName, QuestionHandler qHandler, AnswerHandler aHandler, UserHandler uHandler, ReviewHandler rHandler, User user) {
    ...
    /**
     * Displays the "Remove User" page where an admin can enter a user ID to remove.
     *
