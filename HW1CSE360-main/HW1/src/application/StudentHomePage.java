...
public class StudentHomePage {
    ...
    // Updated constructor now accepts QuestionHandler and AnswerHandler
    public StudentHomePage(QuestionHandler questionHandler, AnswerHandler answerHandler, UserHandler userHandler, String userName, DatabaseHelper databaseHelper) {
    ...
    // Helper method: Displays a scene with options to submit a question or display posts.
    public void show(Stage primaryStage) {
        ...
        submitQuestionButton.setOnAction(e -> {
            new Question(questionHandler, answerHandler, userHandler, userName, databaseHelper)
        ...
        logoutButton.setOnAction(e -> {
            ...
            new SetupLoginSelectionPage(databaseHelper, questionHandler, answerHandler, userHandler).show(primaryStage);
        });
