...
public class FirstPage {
	...
	public FirstPage(DatabaseHelper databaseHelper, QuestionHandler qHandler, AnswerHandler aHandler, UserHandler uHandler) {
    ...
    public void show(Stage primaryStage) {
	    ...
	    continueButton.setOnAction(a -> {
	        new AdminSetupPage(databaseHelper, qHandler, aHandler, uHandler).show(primaryStage);
