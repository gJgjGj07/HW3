...
public class UserNameRecognizer {
	...
	public static boolean blank = false;						//public booleans for testing purposes
	public static boolean start = false;
	public static boolean tshort = false;
	public static boolean tlong = false;
	...
	public static String checkForValidUserName(String input) {
		...
		//reset booleans
		blank = false;						//public booleans for testing purposes
		start = false;
		tshort = false;
		tlong = false;
		exclusive = false;
		...
		if(input.length() <= 0) {
			...
			state = -1; // State of -1 for testing reasons
		...
		while (running) {
			...
			case 1: 
				...
				// . -> State 2
				else if ((currentChar == '.') || (currentChar == '-') || (currentChar == '_')) {	// Check for special characters
					nextState = 2;
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				tlong = true;
				userNameRecognizerErrorMessage += 
					"Must have no more than 16 characters.\n";
				return userNameRecognizerErrorMessage;
			}
				...
				exclusive = true;
				userNameRecognizerErrorMessage += 
					"May contain only the characters A-Z, a-z, 0-9.\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
		...
		case 2:
			...
			special = true;
			userNameRecognizerErrorMessage +=
				"Special character must be followed by A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
