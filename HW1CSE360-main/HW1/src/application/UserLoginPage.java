...
public class UserLoginPage {
    ...
    public UserLoginPage(DatabaseHelper databaseHelper, AnswerHandler aHandler, QuestionHandler qHandler, UserHandler uHandler) {
    ...
    public void show(Stage primaryStage) {
        ...
        loginButton.setOnAction(a -> {
            ...
            try {
                ...
                WelcomeLoginPage welcomeLoginPage = new WelcomeLoginPage(databaseHelper, userName, qHandler, aHandler, uHandler, user);
 ...
 // Method to redirect user to the password reset page
    private void redirectToPasswordReset(int userId, Stage primaryStage) {
        ...
        passwordResetPage.setOnPasswordReset(() -> {
            UserLoginPage loginPage = new UserLoginPage(databaseHelper, aHandler, qHandler, uHandler);
